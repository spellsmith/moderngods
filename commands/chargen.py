...
Belongs in game/commands/chargen.py

Taken from the Ainneve chargen contribution.

Modern Gods, like Ainneve implements MULTISESSION_MODE = 2, in which 
accounts enter an OOC state immediately after creation. From that state, 
the @charcreate command is available to create a new character. This 
command launches the ModernGods character creation EvMenu.
