...
class CmdMobOnOff(Command):
    ...
    def func(self):
        ...
        if not self.args:
            ...
            return
        mob = self.caller.search(self.args.strip())
        if not mob:
            return
...
class Mob(DefaultObject):
    ...
    def at_object_creation(self):
        ...
        self.db.patrolling_pace = 60
        self.db.aggressive_pace = 10
        self.db.hunting_pace = 5
        self.db.death_pace = 120  # stay dead for 100 seconds
        ...
        # some other place.
        self.db.send_defeated_to = "limbo"
    ...
    def do_patrol(self, *args, **kwargs):
        ...
        """
        if random.random() < 0.3 and self.db.irregular_msgs:
